 ...
 * Input: s = "abcabcbb"
 * Output: 3
 * Explanation: The answer is "abc", bca, or cab, with the length of 3.
 * 
 * Example 2:
 * Input: s = "bbbbb"
 * Output: 1
...
public class LengthOfLongestSubstring {
	 ...
	 * 2. Iterate 'end' over the string: if the character exists in the map, update 'start' to the next index of the
	 * existing character, and update the maximum length by comparing the current length with (end - start + 1).
